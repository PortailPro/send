...
- [ ] It should look and feel like the Portailpro Send Web Client
...
This document tracks differences between the UX spec for Portailpro Send and the intended MVP.

...
sendYourFilesLink = Essayer Portailpro Send
...
notSupportedOutdatedDetail = Malheureusement, cette version de Firefox ne prend pas en charge les technologies web utilisées par Portailpro Send. Vous devez mettre à jour votre navigateur.
...
javascriptRequired = Portailpro Send nécessite JavaScript
whyJavascript = Pourquoi Portailpro Send nécessite-t-il JavaScript ?

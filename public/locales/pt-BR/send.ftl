...
sendYourFilesLink = Experimente o Portailpro Send
...
notSupportedOutdatedDetail = Infelizmente essa versão do Firefox não suporta a tecnologia web que faz o Portailpro Send funcionar. Você precisa atualizar o seu navegador.
...
javascriptRequired = O Portailpro Send requer JavaScript
whyJavascript = Por que o Portailpro Send precisa do JavaScript?

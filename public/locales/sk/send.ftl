...
sendYourFilesLink = Vyskúšajte Portailpro Send
...
notSupportedOutdatedDetail = Žiaľ, táto verzia Firefoxu nepodporuje webovú technológiu, ktorá poháňa Portailpro Send. Budete musieť aktualizovať svoj prehliadač.
...
javascriptRequired = Portailpro Send vyžaduje JavaScript
whyJavascript = Prečo Portailpro Send vyžaduje JavaScript?

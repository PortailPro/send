...
sendYourFilesLink = Portailpro Send ausprobieren
...
notSupportedOutdatedDetail = Leider unterstützt diese Firefox-Version die Web-Technologie nicht, auf der Portailpro Send basiert. Du musst deinen Browser aktualisieren.
...
javascriptRequired = Portailpro Send benötigt JavaScript
whyJavascript = Warum benötigt Portailpro Send JavaScript?

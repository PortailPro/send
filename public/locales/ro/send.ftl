...
sendYourFilesLink = Încearcă Portailpro Send
...
notSupportedOutdatedDetail = Din păcate, această versiune de Firefox nu suportă tehnologiile web din spatele Portailpro Send. Va trebui să actualizezi browserul.
...
javascriptRequired = Portailpro Send necesită JavaScript
whyJavascript = De ce Portailpro Send necesită JavaScript?

...
sendYourFilesLink = Prøv Portailpro Send
...
notSupportedOutdatedDetail = Dessverre støtter ikke denne versjonen av Firefox netteknologien som driver Portailpro Send. Du trenger å oppdatere nettleseren din.
...
javascriptRequired = Portailpro Send krever JavaScript.
whyJavascript = Hvorfor krever Portailpro Send JavaScript?

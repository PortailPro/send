...
sendYourFilesLink = Dùng thử Portailpro Send
...
notSupportedOutdatedDetail = Thật không may là phiên bản Firefox này không hỗ trợ công nghệ được sử dụng trong Portailpro Send. Bạn cần cập nhật trình duyệt của bạn.
...
javascriptRequired = Portailpro Send cần JavaScript
whyJavascript = Tại sao Portailpro Send cần JavaScript?

...
sendYourFilesLink = Testa Portailpro Send
...
notSupportedOutdatedDetail = Tyvärr stödjer den här versionen av Firefox inte webbtekniken som driver Portailpro Send. Du måste uppdatera din webbläsare.
...
javascriptRequired = Portailpro Send kräver JavaScript
whyJavascript = Varför kräver Portailpro Send JavaScript?

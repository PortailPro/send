...
sendYourFilesLink = Prova Portailpro Send
...
notSupportedOutdatedDetail = Purtroppo questa versione di Firefox non supporta le tecnologie web alla base di Portailpro Send. È necessario aggiornare il browser.
...
javascriptRequired = Portailpro Send richiede JavaScript
whyJavascript = Perché Portailpro Send richiede JavaScript?

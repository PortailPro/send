...
sendYourFilesLink = Vyzkoušejte Portailpro Send
...
notSupportedOutdatedDetail = Tato verze Firefoxu bohužel nepodporuje webovou technologii, která pohání Portailpro Send. Musíte aktualizovat svůj prohlížeč.
...
javascriptRequired = Portailpro Send vyžaduje povolený JavaScript
whyJavascript = Proč Portailpro Send vyžaduje povolený JavaScript?

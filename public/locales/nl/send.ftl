...
sendYourFilesLink = Portailpro Send proberen
...
notSupportedOutdatedDetail = Helaas ondersteunt deze versie van Firefox de webtechnologie die Portailpro Send gebruikt niet. U dient uw browser bij te werken.
...
javascriptRequired = Portailpro Send vereist JavaScript
whyJavascript = Waarom vereist Portailpro Send JavaScript?

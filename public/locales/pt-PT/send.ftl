...
sendYourFilesLink = Experimentar o Portailpro Send
...
notSupportedOutdatedDetail = Infelizmente esta versão do Firefox não suporta a tecnologia web que faz o Portailpro Send funcionar. Precisa de atualizar o seu navegador.
...
whyJavascript = Porque é que o Portailpro Send requer JavaScript?

...
sendYourFilesLink = Portailpro Send probearje
...
notSupportedOutdatedDetail = Spitigernôch stipet dizze ferzje fan Firefox de webtechnology dy't Portailpro Send mooflik makket net. Jo moatte jo browser fernije.
...
javascriptRequired = Portailpro Send fereasket JavaScript.
whyJavascript = Werom hat Portailpro Send JavaScript nedich?

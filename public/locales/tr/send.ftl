...
sendYourFilesLink = Portailpro Send’i deneyin
...
notSupportedOutdatedDetail = Kullandığınız Firefox sürümü Portailpro Send için gereken web teknolojilerini desteklemiyor. Tarayıcınızı güncellemeniz gerekiyor.
...
javascriptRequired = Portailpro Send için JavaScript gerekir
whyJavascript = Portailpro Send neden JavaScript kullanıyor?

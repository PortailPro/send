...
sendYourFilesLink = Preskusite Portailpro Send
...
notSupportedOutdatedDetail = Ta brskalnik žal ne podpira tehnologije, na kateri temelji Portailpro Send. Svoj brskalnik boste morali posodobiti.
...
javascriptRequired = Portailpro Send zahteva JavaScript
whyJavascript = Zakaj Portailpro Send zahteva JavaScript?

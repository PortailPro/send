...
notSupportedOutdatedDetail = Desværre understøtter denne version af Firefox ikke den webteknologi, som driver Portailpro Send. Du skal opdatere din browser.
...
javascriptRequired = Portailpro Send kræver JavaScript
whyJavascript = Hvorfor kræver Portailpro Send JavaScript?

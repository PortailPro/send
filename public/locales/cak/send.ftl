...
sendYourFilesLink = Titojtob'ëx Portailpro Send
...
notSupportedOutdatedDetail = K'ayew ruma re ruwäch Firefox re' man nuköch' ta ri ajk'amaya'l na'ob'äl nrajo' ri Portailpro Send. Rajowaxik nak'ëx ri awokik'amaya'l.
...
javascriptRequired = K'atzinel JavaScript chi re ri Portailpro Send
whyJavascript = ¿Achike ruma toq ri Portailpro Send nrajo' JavaScript?

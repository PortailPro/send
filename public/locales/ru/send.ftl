...
sendYourFilesLink = Попробовать Portailpro Send
...
notSupportedOutdatedDetail = К сожалению, эта версия Firefox не поддерживает веб-технологию, благодаря которой работает Portailpro Send. Ваш нужно обновить свой браузер.
...
javascriptRequired = Для Portailpro Send необходим JavaScript
whyJavascript = Почему Portailpro Send требуется JavaScript?

...
sendYourFilesLink = Portailpro Send wopytaś
...
notSupportedOutdatedDetail = Bóžko toś ta wersija Firefox webtechnologiju njepódpěra, na kótarejž Portailpro Send bazěrujo. Musyśo swój wobglědowak aktualizěrowaś.
...
whyJavascript = Cogodla Portailpro Send JavaScript trjeba?

...
sendYourFilesLink = Próbálja ki a Portailpro Sendet
...
notSupportedOutdatedDetail = Sajnos a Firefox ezen verziója nem támogatja a Portailpro Send alapját képező technológiát. Frissítenie kell a böngészőjét.
...
javascriptRequired = A Portailpro Sendhez JavaScript szükséges
whyJavascript = Miért van szükség JavaScriptre a Portailpro Sendhez?

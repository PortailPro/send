...
notSupportedOutdatedDetail = Dessverre støttar ikkje denne versjonen av Firefox nett-teknologien som driv Portailpro Send. Du må å oppdatere nettlesaren din.
...
javascriptRequired = Portailpro Send krev JavaScript.
whyJavascript = Kvifor krev Portailpro Send JavaScript?

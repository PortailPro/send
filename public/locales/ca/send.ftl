...
sendYourFilesLink = Proveu el Portailpro Send
...
notSupportedOutdatedDetail = Aquesta versió del Firefox no admet la tecnologia web amb què funciona el Portailpro Send. Haureu d'actualitzar el navegador.
...
javascriptRequired = El Portailpro Send necessita JavaScript
whyJavascript = Per què el Portailpro Send necessita JavaScript?
...
-send-short-brand = Portailpro Send
-firefox = Firefox
-mozilla = Mozilla
